...
const CalcForm = () => {
  return (
    <div
      ...
      data-aos-offset="500"
    >
      <form className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-y-12 lg:gap-y-0">
        <input
          className=" input placeholder:text-darkblue outline-none"
          type="text"
      ...
      <div className="mt-24 ">
        ...
        <div className="text-gray-500 tracking-[1%]">
          Revenue will change based on mining difficulty and Ethereum pirce.
        </div>
      </div>
    </div>
  );
